...
from ongoing.prescriptors.neat_multi_cp_45.neat_prescriptor_many_objective import Neat
...
def prescribe(start_date_str: str,
    ...
    prescriptor = Neat(prescriptors_file=PRESCRIPTORS_FILE, hist_df=hist_df, config_file=CONFIG_FILE)
