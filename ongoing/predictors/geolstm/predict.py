...
from geolstm_predictor import geoLSTMPredictor
...
DATA_FILE = os.path.join(ROOT_DIR, os.pardir, os.pardir, 'data', "OxCGRT_latest.csv")
...
def predict(start_date: str,
    ...
    """
    # !!! YOUR CODE HERE !!!
    predictor = geoLSTMPredictor(MODEL_WEIGHTS_FILE, COUNTRIES_FILE, DATA_FILE)
